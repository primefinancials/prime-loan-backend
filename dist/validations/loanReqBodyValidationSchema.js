...
exports.createClientLoanSchema = joi_1.default.object({
    ...
    dob: joi_1.default.date().required().label("Date of Birth"),
    nin: joi_1.default.string().required().label("National Identification Number"),
    ...
    annual_income: joi_1.default.number().positive().required().label("Annual Income"),
    ...
    amount: joi_1.default.number().positive().required().label("Loan Amount"),
    reason: joi_1.default.string().required().label("Loan Reason"),
    base64Image: joi_1.default.string().optional().label("Image"),
    outstanding: joi_1.default.number().optional().label("Outstanding Amount"),
    ...
    duration: joi_1.default.number().required().positive().label("Duration"),
    repayment_amount: joi_1.default.number().required().positive().label("Repayment Amount"),
    percentage: joi_1.default.number().required().positive().label("Percentage"),
    loan_date: joi_1.default.date().required().label("Loan Date"),
    repayment_date: joi_1.default.date().required().label("Repayment Date"),
