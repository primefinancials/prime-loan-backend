...
router.get("/create-super-admin", (0, middlewares_1.verifyJwtRest)(), (0, middlewares_1.validateReqBody)(validations_1.createAdminAccountSchema), userController_1.createSuperAdminAccount);
router.get("/activate-admin", (0, middlewares_1.verifyJwtRest)(), (0, middlewares_1.validateReqBody)(validations_1.activateAdminReqBodySchema), userController_1.ActivateAndDeactivateAdmin);
router.get("/activate-user", (0, middlewares_1.verifyJwtRest)(), (0, middlewares_1.validateReqBody)(validations_1.activateUserReqBodySchema), userController_1.ActivateAndDeactivateUser);
